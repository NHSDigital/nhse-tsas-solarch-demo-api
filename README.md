# nhse-tsas-solarch-demo-api

![Build](https://github.com/NHSDigital/nhse-tsas-solarch-demo-api/workflows/Build/badge.svg?branch=master)

This is a specification for the *nhse-tsas-solarch-demo-api* API.
...
## Contributing
Contributions to this project are welcome from anyone, providing that they conform to the [guidelines for contribution](https://github.com/NHSDigital/nhse-tsas-solarch-demo-api/blob/master/CONTRIBUTING.md) and the [community code of conduct](https://github.com/NHSDigital/nhse-tsas-solarch-demo-api/blob/master/CODE_OF_CONDUCT.md).
...
Telling Apigee how to connect to your backend requires a *Target Server*, which you should call named `nhse-tsas-solarch-demo-api-target`.
